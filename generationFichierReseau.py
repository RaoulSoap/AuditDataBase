...
def traitementProfilsCustmerId (pathFile, saveFile, fileName) :
    ...
    print ('Recuperation et Traitement des Donnees : ' + fileName)
...
def traitementProfilsDebit (pathFile, saveFile, fileName1, fileName2) :
    ...
    print ('Recuperation et Traitement des Donnees : ' + fileName2)
    ...
    print ('Recuperation et Traitement des Donnees : ' + fileName1)
...
def create_ams_database():
    ...
    pathFile = listePath[0] + 'AMS' + listePath[2]
    saveFile = listePath[1]
    
    print('Identification des fichiers source ...')
